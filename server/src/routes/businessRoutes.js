...
import { activityLogs, createResource, createStaff, listResource, listStaff, removeResource, updateResource, updateStaff } from '../controllers/businessController.js';
...
router.get('/staff', requirePermission('view'), listStaff); router.post('/staff', requirePermission('edit'), createStaff); router.put('/staff/:id', requirePermission('edit'), updateStaff);
